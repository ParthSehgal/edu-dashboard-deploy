...
// CSV Export & Import
router.get("/export", protect, restrictTo("professor", "ta"), exportGradesCSV);

router.post("/import", protect, restrictTo("professor", "ta"), uploadGrades.single("file"), importGradesCSV);
...
router.get("/", protect, restrictTo("professor", "ta"), getCourseGrades);
