...
const api = axios.create({
  baseURL: 'https://edu-dashboard-deploy.onrender.com/api'
});
...
export const coursesAPI = {
  ...
  reviewTaRequest: async (id, taId, status) => {
    return api.patch(`/courses/${id}/review-ta`, { taId, status });
  }
};
...
export const gradesAPI = {
  getMyGrades: async (courseId) => {
    return api.get(`/courses/${courseId}/grades/my-grades`);
  },
